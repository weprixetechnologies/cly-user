    ...
    if (error) {
        return (
            <div className="flex flex-col items-center justify-center min-h-screen bg-gradient-to-br from-red-50 to-yellow-50 px-4 text-center">
                <span className="text-red-600 font-semibold mt-4 text-base">{error}</span>
                <a href="/login" className="mt-4 inline-block bg-black text-white px-4 py-2 rounded-md">Login</a>
            </div>
        );
    }
